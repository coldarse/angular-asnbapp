              ...
              if (statusCode == "00") {
                ...
                signalrConnection.connection.invoke('deleteCreditCardInfo', true).then((data: string) => {
                  const body =
                  {
                    ...
                    "AGENTCODE":signalrConnection.agentCode,
                    "BRANCHCODE":signalrConnection.branchCode,
                    "BANKTXNREFERENCENUMBER":formatDate(new Date(), 'ddMMyy', 'en') + cardInfo.TID.toString().substring(cardInfo.TID.length - 6) + cardInfo.RRN.toString().substring(cardInfo.RRN.length - 10),
                    "BANKCUSTPHONENUMBER":"",
                    "PAYMENTTYPE":"T",
                    "BANKACCOUNTNUMBER":"",
                    "GUARDIANID":guardianID,
